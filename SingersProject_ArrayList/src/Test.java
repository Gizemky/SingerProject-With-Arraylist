...
public class Test {
    ...
    private static Singers singers = new Singers();           //Objemizi özellik olarak tanimladik baska metodlarin içinde de kullanabilmek için.
    ...
    public static void main(String[] args) {
    	...
    	while (!exit) {                              //çikiþ false degeri idi not exit true degeri oluyor.
